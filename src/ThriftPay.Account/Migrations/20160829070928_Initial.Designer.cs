...
namespace ThriftPay.Account.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20160829070928_Initial")]
    partial class Initial
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ThriftPay.Account.Models.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("ThriftPay.Account.Models.ApplicationUser")
                        .WithMany("Claims")
